...
**Etapa atual:** M1–M4 publicados em `v0.3.0`/`v0.3.1`. Linha `v0.3.x` aberta para M5 (Analítica e Faturamento).
...
**Publicação:** `v0.3.0` (features) + `v0.3.1` (release metadata sync). Linha `v0.2.x` encerrada.
