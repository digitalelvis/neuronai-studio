...
**Etapa atual:** M13 `execute-workflow` Execute in progress (EW-T1…T7 done; next EW-T8) on `feat/execute-workflow` → `v2.1.x`. M12 Studio i18n done. TraceDetail bridge permanece deferred.
---
...
| Ordem | Feature | Status | Spec |
|-------|---------|--------|------|
| 31 | `execute-workflow` | **in progress** (EW-T1…T7 done; EW-T8…T10) | [spec](../features/execute-workflow/spec.md) |
