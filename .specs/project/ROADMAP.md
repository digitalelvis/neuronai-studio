...
**Etapa atual:** M10 `canvas-tool-mode` Execute on `feat/canvas-tool-mode` → `v1.1.x` (AD-025). CTM-T1 done. TraceDetail bridge permanece deferred.
...
| Ordem | Feature | Status | Spec |
|-------|---------|--------|------|
| 28 | `canvas-tool-mode` | **in progress** (CTM-T1–T3 ✅ · T4–T10) | [spec](../features/canvas-tool-mode/spec.md) |
...
19. Execute `canvas-tool-mode` (CTM-T1–T3 ✅ · T4–T10) on `feat/canvas-tool-mode` → `v1.1.x` — [spec](../features/canvas-tool-mode/spec.md) · [tasks](../features/canvas-tool-mode/tasks.md)
