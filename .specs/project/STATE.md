...
**Current Work:** M13 `execute-workflow` Execute — **EW-T1…T6 done**. Next: EW-T7 (`WorkflowAsTool` + ToolResolver). TraceDetail bridge + OBS-06/OTel stay deferred.
...
- [ ] Execute M13 `execute-workflow` (EW-T1…T6 done; EW-T7…T10 pending) on `feat/execute-workflow` → `v2.1.x`
