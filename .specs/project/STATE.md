...
**Current Work:** M13 `execute-workflow` Execute — **EW-T1…T7 done**. Next: EW-T8 (integration smoke Step + Tool Mode). TraceDetail bridge + OBS-06/OTel stay deferred.
...
- [ ] Execute M13 `execute-workflow` (EW-T1…T7 done; EW-T8…T10 pending) on `feat/execute-workflow` → `v2.1.x`
