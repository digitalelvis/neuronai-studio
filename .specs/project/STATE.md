...
**Current Work:** M10 `canvas-tool-mode` Execute on `feat/canvas-tool-mode` → `v1.1.x` (AD-025). CTM-T1–T6 done. Next: CTM-T7. TraceDetail bridge + OBS-06/OTel stay deferred.
