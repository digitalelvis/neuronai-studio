...
**Current Work:** M13 `execute-workflow` **specified** (spec/design/tasks ready). Next: Execute EW-T1…T10 on `feat/execute-workflow` → `v2.1.x`. TraceDetail bridge + OBS-06/OTel stay deferred.
...
- [ ] Execute M13 `execute-workflow` (EW-T1…T10) on `feat/execute-workflow` → `v2.1.x`
