...
**Status**: Partial — CE + UA done; UE **debt**
**Linha**: `v0.4.x` (CE in `v0.4.0`; UA implemented; UE debt)
...
**Total**: 31 atomic tasks (24 done, 7 debt)
...
UE remains deferred (AD-015); UA-T7 provides Dashboard aggregates.
