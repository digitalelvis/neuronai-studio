    ...
    <div class="studio-shell">
        <aside class="studio-icon-rail" aria-label="{{ __('neuronai-studio::ui.nav.main') }}">
            ...
            <nav class="flex flex-1 flex-col py-2">
                ...
                <a href="{{ route('neuronai-studio.skills.index') }}" class="studio-icon-rail-link {{ request()->routeIs('neuronai-studio.skills.*') ? 'active' : '' }}" title="{{ __('neuronai-studio::ui.nav.skills') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg>
                </a>
                @if (config('neuronai-studio.plugins.enabled'))
                <a href="{{ route('neuronai-studio.plugins.index') }}" class="studio-icon-rail-link {{ request()->routeIs('neuronai-studio.plugins.*') ? 'active' : '' }}" title="{{ __('neuronai-studio::ui.nav.plugins') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"/></svg>
                </a>
                @endif
